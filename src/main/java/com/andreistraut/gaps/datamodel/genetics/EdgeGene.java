...
/**
 * Wrapper around
 * {@link com.andreistraut.gaps.datamodel.graph.DirectedWeightedEdge} providing
...
public class EdgeGene extends BaseGene {
    ...
    /**
     * Sets the value of this gene (edge) to the new given value. Allele must be
     * an instance of
    ...
    /**
     * Each Gene implementation holds its own value object keeping the allele
     * value {@link com.andreistraut.gaps.datamodel.graph.DirectedWeightedEdge}
     *
     * @return The
     * {@link com.andreistraut.gaps.datamodel.graph.DirectedWeightedEdge}
    ...
    /**
     * Retrieves a string representation of the value of this Gene (edge)
     * instance that includes any information required to reconstruct it at a
     * later time, such as its value and internal state
     *
     ...
     * implementation
     *
     * @param numberGenerator The random number generator that should be used to
     * create any random values. Generated values will be used to set gene
     * (edge) costs
     */
    @Override
    ...
    /**
     * Mutates the allele of this gene, setting its cost to a random number
     * between 0 (inclusive) and index given as parameter (exclusive), with the
     * probability of this happening being percentage given as parameter. For
